...
from .utils import get_preds_fromhm, crop
...
class FAN(nn.Module):
    DOWNLOAD_URL = "https://www.adrianbulat.com/downloads/python-fan/3DFAN-4.pth.tar"
    ...
    def forward_with_crop(self, imgs: torch.Tensor, boxes: np.ndarray):
        # imgs: [N, 3, H, W]
        # boxes: [] cropbox for face region
